...
$(".blue-slant").css({"clip-path": "polygon(110% 0, 100% 0, 100% 100%, 0% 100%)","-webkit-clip-path":"polygon(0% 0, 100% 0, 100% 100%, 0% 100%)", "left":"0"})
...
$(".vh25 > div:nth-child(1)").css({"position": "relative","top":"-180px","left":"-35px"})
$(".vh25 > div:nth-child(2)").css({"position": "relative","top":"-306px","left":"133px"})
$(".vh25 > div:nth-child(3)").css({"position": "relative","top":"-306px","left":"-35px"})
$(".vh25 > div:nth-child(4)").css({"position": "relative","top":"-433px","left":"133px"})
$(".vh25 > div:nth-child(5)").css({"position": "relative","top":"-456px","left":"50px"})
$('.home-testimonial').css({"height":"518px"})
$("#testimonial").css({"font-size": "18px","letter-spacing":"2.2px","line-height":"1.44","position":"relative","top":"-180px","left":"12px","width":"330px"})
$("#quote").css({"font-size": "14px","letter-spacing":"2.2px","line-height":"1.44","position":"relative","top":"-255px","right":"0px"})
...
$('.home-community').css({"height":"862px"})
$('.home-community-logos > img').css({"width":"88.7px","height":"34.4px"})
...
$('#community-btn').css({"width":"190px","height":"14px", "font-size":"8px","position":"relative","left":"50%","transform":"translate(-50%,-50%)", "border":"2px solid #c2d500", "margin-top":"50px", "padding-bottom":"24.281px"})
...
$('#who_story_p, #who_team_p, .acq > p').css({"font-size":"12px","line-height":"1.5","letter-spacing":".2px","color":"#002f87","width":"355px","height":"51px","position":"relative","top":"-100px","left":"-2px","color":"#494b50"})
...
//remove play video text on play
$('.play-icon').click(()=>{
$('#text-play').toggle()
})
})
