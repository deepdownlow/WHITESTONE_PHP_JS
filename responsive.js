...
$(document).ready(() => {
 const responsive = (...args) => {
  if (iPhoneX.matches) {
   ...
   //NAVBAR
   $('#nav_bar_top').css({ "position": "fixed", "top": "120px", "width": "375px", "display": "none" })
   $('.text-right > li').css({ "color": "red", "display": "block" })
   $('.text-right > li > a').css({ "position": "relative", "right": "0", "display": "none" })
   ...
   //HAMBURGER MENU
   $('.hamburger-menu').css({ "position": "fixed", "top": "68px", "right": "170px", "color": "#002f87", "font-size": "28.8px" })
   ...
   $('#who_story_quote_name').css({ "font-size": "11px", "color": "#494b50", "height": "40px", "position": "relative", "top": "-114px", "right": "0", "margin-bottom": "70px" })
   $('#who_story_main').css({ "height": "100px" })
   $('#who_story_img').css({ "max-width": "325px", "position": "relative", "top": "-269px" })
   $('#who_story_head').css({ "position": "relative", "top": "-243px", "left": "-10px" })
   $('#who_story_text_box img').css({ "position": "relative", "top": "-227px" })
   $('#who_story_text_box_2').css({ "margin-bottom": "-52px" })
   $('#who_story_text_box_2 h6').css({ "position": "relative", "top": "-264px", "left": "50px", "font-size": "14px", "width": "332px" })
   $('#who_story_text_box_2 p').css({ "position": "relative", "top": "-297px", "left": "50px", "font-size": "11px", "width": "302px", "line-height": "1.6" })
   $('#who_story_dis').css({ "height": "530px" })
   $('.dist-item').css({ "margin-bottom": "40px" })
   $('#who_story_container > div:nth-child(4)').css({ "margin-top": "-75px" })
   $('.play-icon > img').css({ "width": "-75px", "width": "82px", "height": "82px" })
